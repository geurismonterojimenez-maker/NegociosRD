...
Sello de Recibido Empresa (Fecha y Hora):`;
  ...
  return (
    <div className="fixed inset-0 bg-[#0F172A]/70 z-[100] flex items-center justify-center p-2 sm:p-4 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white border border-gray-250 rounded-2xl shadow-2xl w-full max-w-[110rem] my-auto animate-in fade-in-50 zoom-in-95 duration-200 text-left flex flex-col max-h-[96vh] sm:max-h-[92vh] overflow-hidden">
        ...
        <div className="flex-grow overflow-y-auto p-4 sm:p-6 bg-white">
          <div className="grid grid-cols-1 xl:grid-cols-[160px_minmax(0,1fr)_160px] 2xl:grid-cols-[180px_minmax(0,1fr)_180px] gap-4 items-start">
            <aside className="hidden xl:block sticky top-0 h-[calc(92vh-15rem)] min-h-[520px]">
