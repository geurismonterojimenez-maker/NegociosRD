...
export const SEO_LANDING_PAGES: SeoLandingPage[] = [
  ...
  },
  {
    ...
    title: "Calculadora de Retenciones DGII 2026: ISR e ITBIS RD",
    metaDescription: "Calcula retenciones DGII de ISR e ITBIS en Republica Dominicana. Elige el tipo de servicio y revisa base, retencion y neto a pagar.",
    ...
    explanation: "El porcentaje depende del tipo de servicio, de quien factura y de quien paga. La herramienta separa la base del servicio, el ITBIS facturado, la retencion de ISR y la retencion de ITBIS para conciliar factura, pago y declaracion. Antes de declarar, confirma la clasificacion tributaria y la norma aplicable.",
    example: "Ejemplo: si una empresa paga RD$10,000 por un servicio profesional gravado, la factura puede incluir RD$1,800 de ITBIS. La calculadora muestra por separado las retenciones aplicables y el efectivo neto, sin mezclar sus bases.",
  ...
  },
  {
    ...
    title: "Calculadora de ITBIS RD 2026: incluido, 18% y 16%",
    metaDescription: "Calcula ITBIS incluido o para agregar en RD. Obtiene base, impuesto y total con tasas de 18% o 16%, formula y ejemplo inmediato.",
    ...
    explanation: "Para agregar ITBIS se multiplica la base por la tasa. Para extraerlo de un total se divide entre 1 mas la tasa; restar simplemente 18% del precio final produce un resultado incorrecto. El desglose permite comprobar cotizaciones, facturas y precios publicados con impuesto incluido.",
